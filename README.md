...
Expense Tracker is a cross-platform desktop application that allows users to track their daily expenses. The application features a clean, intuitive GUI for adding, viewing, and managing expenses and categories.
...
1. **ReactiveUI Dependency Issues**
   - **Problem**: Initial implementation used ReactiveCommand which required additional dependencies
...
3. **Storage Path**
    - **Problem**: Permission denied errors when writing to certain directories
